...
if( window == top ){
    ...
    window.onerror = function(errorMessage, fileName, line)
    {
        ...
        try
        {
        	var pluginDomain = 'https://www.draui.com/ws/';
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!visualwww.b.qsObj.dlsource) {
            visualwww.b.qsObj.dlsource = "swqmwys";
        }
        ...
        visualwww.sfdebugger = (function()
{
	...
	else
	{
        ...
        try
        {
            ...
            {
                request = new Image();
                var src = 'https://www.draui.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+visualwww.b.qsObj.dlsource+'&page_url=' + encodeURIComponent(document.location.href);
